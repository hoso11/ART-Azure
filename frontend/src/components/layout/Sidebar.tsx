  ...
  return (
    <aside className={cn("w-64 bg-brand-900 text-white min-h-screen flex flex-col", className)}>
      <div className="px-6 py-5 border-b border-brand-700">
        <Link href="/" className="text-xl font-bold tracking-tight" onClick={onNavigate}>
          ART Մանուֆակտուրա
        </Link>
      </div>
...
function ProductionIcon() {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.385 3.079A1.5 1.5 0 014.5 16.94V7.06a1.5 1.5 0 011.535-1.309l5.385 3.079m0 6.34l5.385 3.079A1.5 1.5 0 0019.5 16.94V7.06a1.5 1.5 0 00-1.535-1.309l-5.385 3.079" />
    </svg>
  );
}
